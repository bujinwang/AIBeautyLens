...
export class TreatmentsController {
  ...
  // async createTreatmentRecord(@Body() createTreatmentRecordDto: CreateTreatmentRecordDto): Promise<TreatmentRecordResponseDto> {
  ...
  //   // @Query() pageOptionsDto: PageOptionsDto, // For pagination
  //   // @Query('patientId') patientId?: string,
  //   // @Query('clinicianId') clinicianId?: string,
  // ): Promise<TreatmentRecordResponseDto[]> { // Paginated<TreatmentRecordResponseDto> later
  //   // return this.treatmentsService.findAllTreatmentRecords(pageOptionsDto, patientId, clinicianId);
