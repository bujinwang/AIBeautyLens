...
const predictionServiceClient = new aiplatform_1.PredictionServiceClient({
 ...
 */
const analyzeImage = async (message) => {
    try {
        ...
        await analysisRecordRef.set({
            ...
            modelUsed: MODEL,
            analysisDate: firestore_1.FieldValue.serverTimestamp(), // Use FieldValue directly
            status: 'completed',
        });
        ...
        await imageRef.update({
            ...
            status: 'analyzed',
            updatedAt: firestore_1.FieldValue.serverTimestamp(), // Use FieldValue directly
        });
